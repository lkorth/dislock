...
Pebble Locker makes use of the [Device Administration API](http://developer.android.com/guide/topics/admin/device-admin.html) to control Android's lock screen. 
...
Pebble Locker *does not* support:
...
To uninstall you must deactivate Pebble Locker as a device admin either in Pebble Locker or in your device's menu. You may or may not need to reboot.
...
Pebble Locker is open source and available under the MIT license. See the [LICENSE](LICENSE) file for more info.
